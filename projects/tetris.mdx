...
thumbnail: "/Tetris/Tetris_Thumb.jpg"
featured: true
---
...
<div class="my-0 flex md:flex-row flex-col justify-evenly">
    <div class="px-4 w-1/4">
        <img class="mb-0 mx-auto" src="/Tetris/game_area.jpg"/>
        <div class="text-center">Game Area</div>
    </div>
    <div class="px-4 w-1/4">
        <img class="mb-0 mx-auto" src="/Tetris/title_screen.gif"/>
        <div class="text-center">Title Screen</div>
    </div>
    <div class="px-4 w-1/4">
        <img class="mb-0 mx-auto" src="/Tetris/game_over.gif"/>
...
<div class="my-0 flex md:flex-row flex-col justify-evenly">
    <div class="px-4 w-3/4">
        <img class="mb-0 mx-auto" src="/Tetris/demo.gif"/>
